...
*~/dotfiles/channels.scm:*

#+begin_src scheme :mkdirp t :tangle ./channels.scm
...
#+begin_src sh
  ...
  sudo -E guix system -L ~/.config/guix/systems reconfigure ~/.config/guix/system/davinci.scm
...
#+begin_src scheme :mkdirp t :tangle .config/guix/system/base-system.scm
;; -*- buffer-read-only: t; -*-
;; NOTE: This file is generated from ~/.dotfiles/System.org.  Please see commentary there.
...
**** *./config/guix/system/zeus.scm:*

#+begin_src scheme :mkdirp t :tangle ./config/guix/system/zeus.scm
;; -*- buffer-read-only: t; -*-
;; NOTE: This file is generated from ~/.dotfiles/System.org.  Please see commentary there.
...
#+begin_src scheme :mkdirp t :notangle .config/guix/manifests/transition.scm
(specifications->manifest
 '())
...
The file =.config/mimeapps.list= configures default applications for various content types.
Currently disabled - I don't use qutebrowser...
#+begin_src conf :mkdirp t :notangle .config/mimeapps.list
