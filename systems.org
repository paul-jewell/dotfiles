...
(setq dw/system-settings
  (map-merge
    ...
    '((desktop/dpi . 180)
      ...
      ;; David has a 4K monitor - I suspect these font sizes will be a problem on a 1084p monitor
...
(operating-system
 ...
 (bootloader
  (bootloader-configuration
   ...
   (keyboard-layout keyboard-layout)))
 (swap-devices
  (list (uuid "24a8f7e7-c62e-453e-91bb-91fbb9f09209")))
 (file-systems
  (cons* (file-system
          (mount-point "/")
          (device
           (uuid "e52ab0d9-a6b7-47dd-a1b3-256b1a491e73"
                 'ext4))
          (type "ext4"))
         %base-file-systems)))
...
David Wilson's system =davinci= is a ThinkPad T480s that I use at my day job.
