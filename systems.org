...
#+begin_src scheme :tangle .config/shepherd/init.d/mcron.scm
(define mcron
  (make <service>
    #:provides '(mcron)
    #:respawn? #t
...
#+begin_src scheme :tangle .config/shepherd/init.d/syncthing.scm
(define syncthing
  (make <service>
    #:provides '(syncthing)
    ...
    #:start (make-forkexec-constructor
             ...
             #:log-file (string-append (gentenv "HOME")
                                       "/log/syncthing.log"))
    #:stop  (make-kill-destructor)
    #:respawn #t))
...
#+begin_src scheme :tangle .config/shepherd/init.d/pulseaudio.scm
(define pulseaudio
  (make <service>
    #:provides '(pulseaudio)
    #:respawn? #t
