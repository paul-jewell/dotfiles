...
#+begin_src scheme :mkdirp yes :tangle ./dotfiles/.config/guix/channels.scm
;; -*- buffer-read-only: t; -*-
...
#+begin_src scheme :mkdirp yes :notangle ./.config/guix/channels.scm
...
#+begin_src sh
  ...
  sudo guix system -L ~/output/guix/systems reconfigure ~/output/guix/systems/davinci.scm
...
#+begin_src scheme :mkdirp yes :tangle ./output/guix/systems/base-system.scm
;; -*- buffer-read-only: t; -*-
;; NOTE: This file is generated from ~/.dotfiles/System.org.  Please see commentary there.
...
#+begin_src scheme :mkdirp yes :tangle ./output/.config/guix/systems/base-system.scm
...
#+begin_src emacs-lisp :mkdirp yes :tangle ~/.emacs.d/per-system-settings.el :noweb yes
...
#+begin_src scheme :mkdirp yes :tangle ./.config/guix/systems/zeus.scm
;; -*- buffer-read-only: t; -*-
;; NOTE: This file is generated from ~/.dotfiles/System.org.  Please see commentary there.
...
#+begin_src cli :mkdirp yes :tangle ./home/files/mpd/mpd.conf
...
#+begin_src scheme :mkdirp yes :tangle ./home/zeus/core.scm
  (use-modules
   (gnu home)
   (gnu home services)
...
#+begin_src scheme :mkdirp yes :no-tangle ./home/zeus/core.scm
...
***** Syncing Passwords
#+begin_src sh :mkdirp yes :tangle .bin/sync-passwords :shebang #!/bin/sh
...
*Syncing Passwords*
#+begin_src scheme :mkdirp yes :tangle .config/cron/pass-sync.guile
...
#+begin_src scheme :mkdirp yes :tangle .config/guix/manifests/window-manager.scm
...
#+begin_src sh :mkdirp yes :notangle .xsession :shebang #!/bin/sh
...
#+begin_src conf :mkdirp yes :tangle .config/xsettingsd/xsettingsd.conf :noweb yes
...
#+begin_src xml :mkdirp yes :tangle .config/fontconfig/fonts.conf
...
*** Browsers
nyxt is the future!
#+begin_src scheme :mkdirp yes :tangle .config/guix/manifests/browsers.scm
(specifications->manifest
 '("ungoogled-chromium"
   "nyxt"
   "lagrange"
...
#+begin_src scheme :mkdirp yes :tangle .config/guix/manifests/code.scm
...
#+begin_src scheme :mkdirp yes :tangle .config/guix/manifests/image.scm
(specifications->manifest
 '("feh"
   "gimp"
   "scrot"))
...
*** Music Player
#+begin_src conf :mkdirp yes :tangle .config/mpd/mpd.conf
music_directory   "~/music"
playlist_directory "~/.config/mpd/playlists"
...
*** Games
#+begin_src scheme :mkdirp yes :tangle .config/guix/manifests/games.scm
(specifications->manifest
 '("aisleriot"
   "gnome-mahjongg"))
...
#+begin_src scheme :mkdirp yes :tangle .config/guix/manifests/music.scm
...
#+begin_src scheme :mkdirp yes :tangle .config/guix/manifests/video.scm
;; Video creation tools
...
#+begin_src conf :mkdirp yes :tangle .config/dunst/dunstrc :noweb yes
...
#+begin_src scheme :mkdirp yes :tangle .config/guix/manifests/desktop.scm :noweb yes
...
#+begin_src conf :mkdirp yes :tangle .config/mpv/mpv.conf :noweb yes
...
#+begin_src scheme :mkdirp yes :tangle .config/shepherd/init.scm
...
#+begin_src scheme :mkdirp yes :tangle .config/shepherd/init.d/gpg-agent.scm
(define gpg-agent
  (make <service>
    #:provides '(gpg-agent)
    #:respawn? #t
...
#+begin_src scheme :mkdirp yes :tangle .config/shepherd/init.d/mcron.scm
(define mcron
  (make <service>
    #:provides '(mcron)
    #:respawn? #t
...
#+begin_src scheme :mkdirp yes :notangle .config/shepherd/init.d/emacs.scm
(define emacs
  (make <service>
    #:provides '(emacs)
    #:requires '()
...
#+begin_src scheme :mkdirp yes :tangle .config/shepherd/init.d/syncthing.scm
(define syncthing
  (make <service>
    #:provides '(syncthing)
...
#+begin_src scheme :mkdirp yes :tangle .config/shepherd/init.d/pulseaudio.scm
(define pulseaudio
  (make <service>
    #:provides '(pulseaudio)
    #:respawn? #t
...
#+begin_src scheme :mkdirp yes :tangle .config/shepherd/init.d/mpd.scm
(define mpd
  (make <service>
    #:provides '(mpd)
    #:respawn? #t
...
#+begin_src sh :mkdirp yes :tangle ./.bin/activate-profiles :shebang #!/bin/sh
# -*- buffer-read-only: t; -*-
# NOTE: This file is generated from ~/.dotfiles/System.org.  Please see commentary there.
...
#+begin_src sh :mkdirp yes :tangle ./.bin/update-profiles :shebang #!/bin/sh
# -*- buffer-read-only: t; -*-
# NOTE: This file is generated from ~/.dotfiles/System.org.  Please see commentary there.
...
#+begin_src sh :mkdirp yes :tangle ./.bin/sync-dotfiles :shebang #!/bin/sh
# -*- buffer-read-only: t; -*-
