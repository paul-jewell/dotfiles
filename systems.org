...
#+begin_src sh
  ...
  sudo -E guix system -L ~/dotfiles/systems reconfigure ~/dotfiles/system/davinci.scm

#+end_src

This is also executed by running Make $(system)-system in the dotfiles directory

*dotfiles/system/base-system.scm:*

#+begin_src scheme :mkdirp t :tangle ./system/base-system.scm
;; -*- buffer-read-only: t; -*-
;; NOTE: This file is generated from ~/.dotfiles/System.org.  Please see commentary there.
...
#+begin_src scheme :mkdirp t :tangle ./system/zeus.scm
;; -*- buffer-read-only: t; -*-
;; NOTE: This file is generated from ~/.dotfiles/System.org.  Please see commentary there.
