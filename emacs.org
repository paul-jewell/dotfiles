...
(use-package vertico
  ...
  (use-package orderless
    ...
    (completion-categur-defaults nil)
...
(defvar my:font (concat "Firacodenerdfontmono-" *pj/font-size*))
...
;;       ("Fantasque Sans Mono-15")
;;       ("DejaVu Sans Mono-14" . "DejaVu Sans")
;;       ("Ubuntu Mono-15" . "Ubuntu")
;;       ("Droid Sans Mono-14" . "Droid Sans")
...
;;       ("Anonymous Pro-14")
;;       ("Liberation Mono-14")
;;       ("Fira Mono-14" . "Fira Sans")
;;       ("Fira Code-14" . "Fira Sans")
;;       ("Hack-14")
...
;;         :default-height 140
;;         :fixed-pitch-height 2.0
;;         :fixed-pitch-serif-height 2.0
...
;;       (set-fontset-font
;;        t 'unicode (font-spec :family "Noto Color Emoji") nil 'append)))
