...
* Early init file
#+begin_src emacs-lisp :mkdirp t :tangle ./.emacs.d/early-init.el
;;; -*-buffer-read-only: t;-*- 
...
(fset 'original-suspend-frame (symbol-definition 'suspend-frame))

(defun my-suspend-frame ()
  "A custom version of suspend frame that does nothing in graphical mode."
  (if (displayt-graphic-p)
      (message "Frame suspension is disabled in graphical mode.")
    (original-frame-suspend)))

(add-advice 'suspend-frame :override #'my-suspend-frame)
