...
(require my-themes.el)
(require my-dashboard.el)
(require my-modeline.el)
(require my-treemacs.el)
(require my-tramp.el)
(require my-completion.el)
(require my-which-key.el)
(require my-ispell.el)
(require my-ledger.el)
(require my-lsp.el)
(require my-programming.el)
(require my-erc.el)
(require my-yasnippet.el)
(require my-multiple-cursors.el)
(require my-orgmode.el)
(require my-text-tools.el)
(require my-hydra.el)
(require my-magit.el)
(require my-projectile.el)
(require my-deminish.el)
(require my-paredit.el)
(require my-rainbow-delimiters.el)
(require my-email.el)
(require my-gnus.el)
(require my-helpful.el)
(require my-security.el)
(require my-hammy.el)
...
the experience.
#+begin_src emacs-lis :tangle ./.emacs.d/pj-modules/my-email.el :mkdirp t
...
#+begin_src emacs-lisp  :tangle ./.emacs.d/pj-projects/my-email.el :mkdirp t
;; Not yet configured
...
* Hammy
#+begin_src emacs-lisp :tangle ./.emacs.d/pj-modules/my-hammy.el :mkdirp t
(use-package hammy
